...
void priority_queue_add_pop_check() {
...

  {
    ...
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task1 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task1_data, task1_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task2 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task2_data, task2_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task3 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task3_data, task3_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task4 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task4_data, task4_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task5 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task5_data, task5_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task6 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task6_data, task6_data_size );
...

  {
    ...
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task1 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task1_data, task1_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task2 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task2_data, task2_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task3 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::MEDIUM, 0, ( unsigned char* ) task3_data, task3_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task4 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::LOW, 0, ( unsigned char* ) task4_data, task4_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task5 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::LOW, 0, ( unsigned char* ) task5_data, task5_data_size );
...

  {
    ...
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task1 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task1_data, task1_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task2 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::LOW, 0, ( unsigned char* ) task2_data, task2_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task3 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::MEDIUM, 0, ( unsigned char* ) task3_data, task3_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task4 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::HIGH, 0, ( unsigned char* ) task4_data, task4_data_size );
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task5 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::LOW, 0, ( unsigned char* ) task5_data, task5_data_size );
    ...
    assert( std::memcmp( pop_task_3->get_task_data().get(), task3_data, task3_data_size ) == 0 );
    assert( std::memcmp( pop_task_4->get_task_data().get(), task2_data, task2_data_size ) == 0 );
    assert( std::memcmp( pop_task_5->get_task_data().get(), task5_data, task5_data_size ) == 0 );
...

  {
    ...
    std::unique_ptr< spyke::priority_queue::Priority_Queue_Task > task3 = std::make_unique< spyke::priority_queue::Priority_Queue_Task >( spyke::priority_queue::Task_Priority::LOW, 0, ( unsigned char* ) task3_data, task3_data_size );
    assert( ! priority_queue.add_new_task( task3 ) );
